  ...
  return (
    <div className={`flex flex-row-reverse ${className}`}>
      ...
      <div
        ...
        } flex-grow flex-col-reverse flex-wrap right-0 mt-12 pt-5 tablet:w-auto tablet:h-auto tablet:m-0 tablet:p-0 tablet:flex tablet:static tablet:flex-row-reverse tablet:flex-nowrap tablet:justify-start tablet:items-center tablet:bg-transparent gap-5 laptop:gap-10`}
      >
