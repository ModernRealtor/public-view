    ...
    <div className={`flex flex-row-reverse ${props.className}`}>
      ...
      <div
        className={`z-50 bg-white w-11/12 h-screen ${
          isOpen ? "fixed" : "hidden"
        } flex-grow flex-col-reverse flex-wrap right-0 mt-11 pt-5 tablet:w-auto tablet:h-auto tablet:m-0 tablet:p-0 tablet:flex tablet:static tablet:flex-row-reverse tablet:flex-nowrap tablet:justify-start tablet:bg-transparent gap-5 desktop:gap-10 isolate`}
      >
