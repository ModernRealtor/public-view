...
export default function Menu(props) {
    ...
    return (
        <div className={`flex flex-row-reverse ${props.className}`}>
            ...
            <div className={`bg-indigo-100 w-screen h-screen ${isOpen? "fixed" : "hidden"} flex-grow flex-col-reverse flex-wrap left-0 mt-11 pt-5 tablet:w-auto tablet:h-auto tablet:m-0 tablet:p-0 tablet:flex tablet:static tablet:flex-row-reverse tablet:flex-nowrap tablet:justify-around isolate`}>
