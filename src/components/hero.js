  ...
  return (
    <div className={`${props.className} pb-10 tablet:pt-10 laptop:py-24 desktop:py-32`}>
      <div className="flex flex-col tablet:flex-row">
        <div className="pt-5 pb-10 desktop:pt-0">
          <h1 className="font-bold py-5 text-4xl capitalize laptop:text-5xl laptop:pb-10 desktop:text-right desktop:text-6xl desktop:pb-14 desktop:pt-0">{heroTitle}</h1>
          <p className="pb-4 desktop:text-right">{heroText}</p>
