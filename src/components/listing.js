        ...
        <div className="w-64 h-72 text-primary text-xs">
            ...
            <div className="w-full h-2/5 gap-3 bg-secondary rounded-b-sm p-3 flex flex-col justify-items-stretch">
                ...
                <div className="flex-grow flex">
                    <button className="w-2/5 text-sm font-normal rounded border-2 border-primary hover:border-accent hover:text-accent ">Book Now</button>
                    <p className="w-3/5 text-center self-center text-base font-bold">${props.info.price.toLocaleString()}</p>
                </div>
            </div>
        </div>
    )
